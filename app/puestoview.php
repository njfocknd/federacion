...
$puesto_view = NULL; // Initialize page object first

class cpuesto_view extends cpuesto {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["idpuesto"] <> "") {
			$this->RecKey["idpuesto"] = $_GET["idpuesto"];
			$KeyUrl .= "&amp;idpuesto=" . urlencode($this->RecKey["idpuesto"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idpuesto"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idpuesto"]);
		}
		...
		$this->idpuesto->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idpuesto"] <> "") {
				...
				$this->RecKey["idpuesto"] = $this->idpuesto->QueryStringValue;
			} elseif (@$_POST["idpuesto"] <> "") {
				$this->idpuesto->setFormValue($_POST["idpuesto"]);
				$this->RecKey["idpuesto"] = $this->idpuesto->FormValue;
			} else {
				$sReturnUrl = "puestolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "puestolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "puestolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_puesto\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_puesto',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fpuestoview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($puesto_view)) $puesto_view = new cpuesto_view();

// Page init
$puesto_view->Page_Init();

// Page main
$puesto_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$puesto_view->Page_Render();
?>
...
var CurrentForm = fpuestoview = new ew_Form("fpuestoview", "view");

// Form_CustomValidate event
fpuestoview.Form_CustomValidate = 
...
fpuestoview.ValidateRequired = true;
<?php } else { ?>
fpuestoview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fpuestoview.Lists["x_idpuesto_tipo"] = {"LinkField":"x_idpuesto_tipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpuestoview.Lists["x_idpersona"] = {"LinkField":"x_idpersona","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpuestoview.Lists["x_idfederacion"] = {"LinkField":"x_idfederacion","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpuestoview.Lists["x_idorgano"] = {"LinkField":"x_idorgano","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpuestoview.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpuestoview.Lists["x_status"].Options = <?php echo json_encode($puesto->status->Options()) ?>;
fpuestoview.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpuestoview.Lists["x_estado"].Options = <?php echo json_encode($puesto->estado->Options()) ?>;
...
<?php } ?>
<?php $puesto_view->ExportOptions->Render("body") ?>
<?php
	foreach ($puesto_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($puesto->Export == "") { ?>
...
<?php } ?>
<?php $puesto_view->ShowPageHeader(); ?>
<?php
$puesto_view->ShowMessage();
?>
<form name="fpuestoview" id="fpuestoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($puesto_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $puesto_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="puesto">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($puesto->idpuesto->Visible) { // idpuesto ?>
	<tr id="r_idpuesto">
		<td><span id="elh_puesto_idpuesto"><?php echo $puesto->idpuesto->FldCaption() ?></span></td>
		<td data-name="idpuesto"<?php echo $puesto->idpuesto->CellAttributes() ?>>
<span id="el_puesto_idpuesto">
<span<?php echo $puesto->idpuesto->ViewAttributes() ?>>
<?php echo $puesto->idpuesto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->idpuesto_tipo->Visible) { // idpuesto_tipo ?>
	<tr id="r_idpuesto_tipo">
		<td><span id="elh_puesto_idpuesto_tipo"><?php echo $puesto->idpuesto_tipo->FldCaption() ?></span></td>
...
<?php echo $puesto->idpuesto_tipo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->idpersona->Visible) { // idpersona ?>
	<tr id="r_idpersona">
		<td><span id="elh_puesto_idpersona"><?php echo $puesto->idpersona->FldCaption() ?></span></td>
...
<?php echo $puesto->idpersona->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->idfederacion->Visible) { // idfederacion ?>
	<tr id="r_idfederacion">
		<td><span id="elh_puesto_idfederacion"><?php echo $puesto->idfederacion->FldCaption() ?></span></td>
...
<?php echo $puesto->idfederacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->idorgano->Visible) { // idorgano ?>
	<tr id="r_idorgano">
		<td><span id="elh_puesto_idorgano"><?php echo $puesto->idorgano->FldCaption() ?></span></td>
...
<?php echo $puesto->idorgano->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->fecha_inicio->Visible) { // fecha_inicio ?>
	<tr id="r_fecha_inicio">
		<td><span id="elh_puesto_fecha_inicio"><?php echo $puesto->fecha_inicio->FldCaption() ?></span></td>
...
<?php echo $puesto->fecha_inicio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->fecha_fin->Visible) { // fecha_fin ?>
	<tr id="r_fecha_fin">
		<td><span id="elh_puesto_fecha_fin"><?php echo $puesto->fecha_fin->FldCaption() ?></span></td>
...
<?php echo $puesto->fecha_fin->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_puesto_status"><?php echo $puesto->status->FldCaption() ?></span></td>
...
<?php echo $puesto->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_puesto_estado"><?php echo $puesto->estado->FldCaption() ?></span></td>
		<td data-name="estado"<?php echo $puesto->estado->CellAttributes() ?>>
<span id="el_puesto_estado">
<span<?php echo $puesto->estado->ViewAttributes() ?>>
<?php echo $puesto->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($puesto->fecha_insercion->Visible) { // fecha_insercion ?>
	<tr id="r_fecha_insercion">
		<td><span id="elh_puesto_fecha_insercion"><?php echo $puesto->fecha_insercion->FldCaption() ?></span></td>
		<td data-name="fecha_insercion"<?php echo $puesto->fecha_insercion->CellAttributes() ?>>
<span id="el_puesto_fecha_insercion">
<span<?php echo $puesto->fecha_insercion->ViewAttributes() ?>>
<?php echo $puesto->fecha_insercion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
