...
fdepartamentodelete.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdepartamentodelete.Lists["x_estado"].Options = <?php echo json_encode($departamento->estado->Options()) ?>;
...
<?php if ($departamento->siglas->Visible) { // siglas ?>
		<th><span id="elh_departamento_siglas" class="departamento_siglas"><?php echo $departamento->siglas->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($departamento->fecha_insercion->Visible) { // fecha_insercion ?>
		<th><span id="elh_departamento_fecha_insercion" class="departamento_fecha_insercion"><?php echo $departamento->fecha_insercion->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_iddepartamento" class="departamento_iddepartamento">
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_siglas" class="departamento_siglas">
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_idpais" class="departamento_idpais">
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_estado" class="departamento_estado">
...
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_fecha_insercion" class="departamento_fecha_insercion">
<span<?php echo $departamento->fecha_insercion->ViewAttributes() ?>>
<?php echo $departamento->fecha_insercion->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
