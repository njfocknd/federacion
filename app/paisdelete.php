	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("paislist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fpaisdelete = new ew_Form("fpaisdelete", "delete");
...
<?php if ($pais->siglas->Visible) { // siglas ?>
		<th><span id="elh_pais_siglas" class="pais_siglas"><?php echo $pais->siglas->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pais->gentilicio_masculino->Visible) { // gentilicio_masculino ?>
		<th><span id="elh_pais_gentilicio_masculino" class="pais_gentilicio_masculino"><?php echo $pais->gentilicio_masculino->FldCaption() ?></span></th>
<?php } ?>
<?php if ($pais->gentilicio_femenino->Visible) { // gentilicio_femenino ?>
		<th><span id="elh_pais_gentilicio_femenino" class="pais_gentilicio_femenino"><?php echo $pais->gentilicio_femenino->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $pais_delete->RowCnt ?>_pais_nombre" class="pais_nombre">
...
<span id="el<?php echo $pais_delete->RowCnt ?>_pais_siglas" class="pais_siglas">
...
<span id="el<?php echo $pais_delete->RowCnt ?>_pais_gentilicio_masculino" class="pais_gentilicio_masculino">
...
<span id="el<?php echo $pais_delete->RowCnt ?>_pais_gentilicio_femenino" class="pais_gentilicio_femenino">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pais_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fpaisdelete.Init();
