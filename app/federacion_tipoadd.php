...
$federacion_tipo_add = NULL; // Initialize page object first

class cfederacion_tipo_add extends cfederacion_tipo {
	...
	// Page object name
	var $PageObjName = 'federacion_tipo_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["idfederacion_tipo"] != "") {
				...
				$this->setKey("idfederacion_tipo", $this->idfederacion_tipo->CurrentValue); // Set up key
			} else {
				$this->setKey("idfederacion_tipo", ""); // Clear key
	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$this->idfederacion_tipo->setDbValue($conn->Insert_ID());
				$rsnew['idfederacion_tipo'] = $this->idfederacion_tipo->DbValue;
			}
		} else {
...
// Create page object
if (!isset($federacion_tipo_add)) $federacion_tipo_add = new cfederacion_tipo_add();

// Page init
$federacion_tipo_add->Page_Init();

// Page main
$federacion_tipo_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$federacion_tipo_add->Page_Render();
?>
...
var CurrentForm = ffederacion_tipoadd = new ew_Form("ffederacion_tipoadd", "add");

// Validate form
ffederacion_tipoadd.Validate = function() {
...
ffederacion_tipoadd.Form_CustomValidate = 
...
ffederacion_tipoadd.ValidateRequired = true;
<?php } else { ?>
ffederacion_tipoadd.ValidateRequired = false; 
<?php } ?>
...
<?php $federacion_tipo_add->ShowPageHeader(); ?>
<?php
$federacion_tipo_add->ShowMessage();
?>
<form name="ffederacion_tipoadd" id="ffederacion_tipoadd" class="<?php echo $federacion_tipo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($federacion_tipo_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $federacion_tipo_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $federacion_tipo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
ffederacion_tipoadd.Init();
</script>
<?php
$federacion_tipo_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$federacion_tipo_add->Page_Terminate();
?>
