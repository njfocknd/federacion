...
$federacion_view = NULL; // Initialize page object first

class cfederacion_view extends cfederacion {
	...
	// Page object name
	var $PageObjName = 'federacion_view';
	...
	function __construct() {
		...
		if (@$_GET["idfederacion"] <> "") {
			$this->RecKey["idfederacion"] = $_GET["idfederacion"];
			$KeyUrl .= "&amp;idfederacion=" . urlencode($this->RecKey["idfederacion"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idfederacion"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idfederacion"]);
		}
		...
		$this->idfederacion->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idfederacion"] <> "") {
				...
				$this->RecKey["idfederacion"] = $this->idfederacion->QueryStringValue;
			} elseif (@$_POST["idfederacion"] <> "") {
				$this->idfederacion->setFormValue($_POST["idfederacion"]);
				$this->RecKey["idfederacion"] = $this->idfederacion->FormValue;
			} else {
				$sReturnUrl = "federacionlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "federacionlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "federacionlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($federacion_view)) $federacion_view = new cfederacion_view();

// Page init
$federacion_view->Page_Init();

// Page main
$federacion_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$federacion_view->Page_Render();
?>
...
var CurrentForm = ffederacionview = new ew_Form("ffederacionview", "view");

// Form_CustomValidate event
ffederacionview.Form_CustomValidate = 
...
ffederacionview.ValidateRequired = true;
<?php } else { ?>
ffederacionview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ffederacionview.Lists["x_idfederacion_tipo"] = {"LinkField":"x_idfederacion_tipo","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ffederacionview.Lists["x_iddeporte"] = {"LinkField":"x_iddeporte","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ffederacionview.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ffederacionview.Lists["x_estado"].Options = <?php echo json_encode($federacion->estado->Options()) ?>;
...
<?php } ?>
<?php $federacion_view->ExportOptions->Render("body") ?>
<?php
	foreach ($federacion_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($federacion->Export == "") { ?>
...
<?php } ?>
<?php $federacion_view->ShowPageHeader(); ?>
<?php
$federacion_view->ShowMessage();
?>
<form name="ffederacionview" id="ffederacionview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($federacion_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $federacion_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="federacion">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($federacion->idfederacion->Visible) { // idfederacion ?>
	<tr id="r_idfederacion">
		<td><span id="elh_federacion_idfederacion"><?php echo $federacion->idfederacion->FldCaption() ?></span></td>
		<td data-name="idfederacion"<?php echo $federacion->idfederacion->CellAttributes() ?>>
<span id="el_federacion_idfederacion">
<span<?php echo $federacion->idfederacion->ViewAttributes() ?>>
<?php echo $federacion->idfederacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($federacion->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_federacion_nombre"><?php echo $federacion->nombre->FldCaption() ?></span></td>
...
<?php echo $federacion->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($federacion->nomenclatura->Visible) { // nomenclatura ?>
	<tr id="r_nomenclatura">
		<td><span id="elh_federacion_nomenclatura"><?php echo $federacion->nomenclatura->FldCaption() ?></span></td>
...
<?php echo $federacion->nomenclatura->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($federacion->idfederacion_tipo->Visible) { // idfederacion_tipo ?>
	<tr id="r_idfederacion_tipo">
		<td><span id="elh_federacion_idfederacion_tipo"><?php echo $federacion->idfederacion_tipo->FldCaption() ?></span></td>
...
<?php echo $federacion->idfederacion_tipo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($federacion->iddeporte->Visible) { // iddeporte ?>
	<tr id="r_iddeporte">
		<td><span id="elh_federacion_iddeporte"><?php echo $federacion->iddeporte->FldCaption() ?></span></td>
...
<?php echo $federacion->iddeporte->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($federacion->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_federacion_estado"><?php echo $federacion->estado->FldCaption() ?></span></td>
		<td data-name="estado"<?php echo $federacion->estado->CellAttributes() ?>>
<span id="el_federacion_estado">
<span<?php echo $federacion->estado->ViewAttributes() ?>>
<?php echo $federacion->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($federacion->fecha_insercion->Visible) { // fecha_insercion ?>
	<tr id="r_fecha_insercion">
		<td><span id="elh_federacion_fecha_insercion"><?php echo $federacion->fecha_insercion->FldCaption() ?></span></td>
		<td data-name="fecha_insercion"<?php echo $federacion->fecha_insercion->CellAttributes() ?>>
<span id="el_federacion_fecha_insercion">
<span<?php echo $federacion->fecha_insercion->ViewAttributes() ?>>
<?php echo $federacion->fecha_insercion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($federacion->Export == "") { ?>
<script type="text/javascript">
ffederacionview.Init();
</script>
<?php } ?>
<?php
$federacion_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($federacion->Export == "") { ?>
...
<?php
$federacion_view->Page_Terminate();
?>
