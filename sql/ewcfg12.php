...
define("EW_PROJECT_NAME", "federacion", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{534073BD-D81F-448B-A31F-640F6B0B930C}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'gWkUql3pf0peFHWc', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/federacion.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "nexthordb.cquvmppcukva.us-west-2.rds.amazonaws.com", "port" => 3306, "user" => "dbadmin", "pass" => "23Nexthor23", "db" => "federacion", "qs" => "`", "qe" => "`");
